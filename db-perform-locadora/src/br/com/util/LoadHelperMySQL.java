	...
	public static List<Actor> carregarAtores() {
		...
		try {
			...
			while (leitor.hasNextLine()) {
				...
				ator.setActorId((short) Integer.parseInt(actorAux[0]));
	...
	public static List<Address> carregarEnderecos() {
		...
		try {
			...
			while (leitor.hasNextLine()) {
				...
				address.setAddressId((short) Integer.parseInt(addressAux[0]));
	...
	public static List<Category> carregarCategorias() {
		...
		try {
			...
			while (leitor.hasNextLine()) {
				...
				category.setCategoryId((short) Integer.parseInt(catAux[0]));
	...
	public static List<City> carregarCidades() {
		...
		try {
			...
			while (leitor.hasNextLine()) {
				...
				cidade.setCityId((short) Integer.parseInt(cityAux[0]));
				cidade.setCity(cityAux[1]);
				cidade.setCountryId(CountryDAO.getInstance().buscarPaisById((short) Integer.parseInt(cityAux[2])));
	...
	public static List<Country> carregarPaises() {
		...
		try {
			...
			while (leitor.hasNextLine()) {
				...
				pais.setCountryId((short) Integer.parseInt(paisAux[0]));
	...
	public static List<Customer> carregarClientes() {
		...
		try {
			...
			while (leitor.hasNextLine()) {
				...
				cliente.setCustomerId((short) Integer.parseInt(cliAux[0]));
				...
				cliente.setAddressId(AddressDAO.getInstance().buscarEnderecoById((short) Integer.parseInt(cliAux[5])));
				cliente.setStoreId(StoreDAO.getInstance().buscarLojaById((short) Integer.parseInt(cliAux[6])));
	...
	public static List<Film> carregarFilmes() {
		...
		try {
			...
			while (leitor.hasNextLine()) {
				...
				filme.setFilmId((short) Integer.parseInt(filmAux[0]));
				filme.setTitle(filmAux[1]);
				filme.setDescription(filmAux[2]);
				filme.setLength((short) Integer.parseInt(filmAux[3]));
				filme.setLanguageId(LanguageDAO.getInstance().buscarIdiomaById((short) Integer.parseInt(filmAux[4])));
				filme.setRating(filmAux[6]);				
				filme.setReleaseYear(filmAux[7]);
				filme.setRentalDuration((short) Integer.parseInt((filmAux[8])));
	...
	public static List<Inventory> carregarInventarios() {
		...
		try {
			...
			while (leitor.hasNextLine()) {
				...
				inventario.setStoreId(StoreDAO.getInstance().buscarLojaById((short) Integer.parseInt(invAux[2])));
	...
	public static List<Language> carregarIdiomas() {
		...
		try {
			...
			while (leitor.hasNextLine()) {
				...
				idioma.setLanguageId((short)Integer.parseInt(idiomaAux[0]));
	...
	public static List<Payment> carregarPagamentos() {
		...
		try {
			...
			while (leitor.hasNextLine()) {
				...
				pagamento.setPaymentId((short)Integer.parseInt(pgtoAux[0]));
				...
				pagamento.setCustomerId(CustomerDAO.getInstance().buscarClienteById((short) Integer.parseInt(pgtoAux[4])));
				
				pagamento.setStaffId(StaffDAO.getInstance().buscarFuncionarioById((short) Integer.parseInt(pgtoAux[5])));
	...
	public static List<Staff> carregarFuncionarios() {
		...
		try {
			...
			while (leitor.hasNextLine()) {
				...
				funcionario.setStaffId((short)Integer.parseInt(staffAux[0]));
				...
				funcionario.setAddressId(AddressDAO.getInstance().buscarEnderecoById((short) Integer.parseInt(staffAux[4])));
				funcionario.setEmail(staffAux[5]);
				funcionario.setUsername(staffAux[6]);
				funcionario.setPassword(staffAux[7]);
				funcionario.setStoreId(StoreDAO.getInstance().buscarLojaById((short)Integer.parseInt(staffAux[8])));
	...
	public static List<Store> carregarLojas() {
		...
		try {
			...
			while (leitor.hasNextLine()) {
				...
				loja.setStoreId((short)Integer.parseInt(lojasAux[0]));
				loja.setAddressId(AddressDAO.getInstance().buscarEnderecoById((short) Integer.parseInt(lojasAux[2])));
