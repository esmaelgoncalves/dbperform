...
import br.com.locadora.mongodb.controller.ActorController;
import br.com.locadora.mongodb.controller.AddressController;
import br.com.locadora.mongodb.controller.CategoryController;
import br.com.locadora.mongodb.controller.CityController;
import br.com.locadora.mongodb.controller.CountryController;
import br.com.locadora.mongodb.controller.CustomerController;
import br.com.locadora.mongodb.controller.FilmController;
import br.com.locadora.mongodb.controller.InventoryController;
import br.com.locadora.mongodb.controller.LanguageController;
import br.com.locadora.mongodb.controller.PaymentController;
import br.com.locadora.mongodb.controller.RentalController;
import br.com.locadora.mongodb.controller.StaffController;
import br.com.locadora.mongodb.controller.StoreController;
 ...
 * 
 */
public class TestesLocadoraMongoDB {
	...
	public static long carregarAtores() {
		...
		// CARREGA USUARIOS
		atores = LoadHelperMongoDB.carregarAtores();
	...
	public static long carregarEnderecos() {
		...
		// CARREGA USUARIOS
		enderecos = LoadHelperMongoDB.carregarEnderecos();
	...
	public static long carregarCategorias() {
		...
		// CARREGA USUARIOS
		categorias = LoadHelperMongoDB.carregarCategorias();
	...
	public static long carregarCidades() {
		...
		// CARREGA USUARIOS
		cidades = LoadHelperMongoDB.carregarCidades();
	...
	public static long carregarPaises() {
		...
		// CARREGA USUARIOS
		paises = LoadHelperMongoDB.carregarPaises();
	...
	public static long carregarClientes() {
		...
		// CARREGA USUARIOS
		clientes = LoadHelperMongoDB.carregarClientes();
	...
	public static long carregarFilmes() {
		...
		// CARREGA USUARIOS
		filmes = LoadHelperMongoDB.carregarFilmes();
	...
	public static long carregarInventarios() {
		...
		// CARREGA USUARIOS
		inventarios = LoadHelperMongoDB.carregarInventarios();
	...
	public static long carregarIdiomas() {
		...
		// CARREGA USUARIOS
		idiomas = LoadHelperMongoDB.carregarIdiomas();
	...
	public static long carregarPagamentos() {
		...
		// CARREGA USUARIOS
		pagamentos = LoadHelperMongoDB.carregarPagamentos();
	...
	public static long carregarLocacoes() {
		...
		// CARREGA USUARIOS
		locacoes = LoadHelperMongoDB.carregarLocacoes();
	...
	public static long carregarFuncionarios() {
		...
		// CARREGA USUARIOS
		funcionarios = LoadHelperMongoDB.carregarFuncionarios();
	...
	public static long carregarLojas() {
		...
		// CARREGA USUARIOS
		lojas = LoadHelperMongoDB.carregarLojas();
	...
	public static long  firstLoadFull() {
		...
		tempoTotal += TestesLocadoraMongoDB.carregarPaises();
		tempoTotal += TestesLocadoraMongoDB.carregarCidades();
		/*tempoTotal += TestesLocadoraMongoDB.carregarEnderecos();
		tempoTotal += TestesLocadoraMongoDB.carregarIdiomas();
		tempoTotal += TestesLocadoraMongoDB.carregarLojas();
		tempoTotal += TestesLocadoraMongoDB.carregarFuncionarios();
		tempoTotal += TestesLocadoraMongoDB.carregarClientes();		
		tempoTotal += TestesLocadoraMongoDB.carregarCategorias();
		tempoTotal += TestesLocadoraMongoDB.carregarAtores();
		tempoTotal += TestesLocadoraMongoDB.carregarFilmes();
		tempoTotal += TestesLocadoraMongoDB.carregarInventarios();
		tempoTotal += TestesLocadoraMongoDB.carregarLocacoes();
		tempoTotal += TestesLocadoraMongoDB.carregarPagamentos();*/
